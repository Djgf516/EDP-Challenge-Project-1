...
addEventListener('DOMContentLoaded', () => {
    ...
    producer = document.querySelector('span#birth_year');
    title = document.querySelector('span#mass');
    episode = document.querySelector('span#height');
    director = document.querySelector('h1#name');
    releaseDate = document.querySelector('span#birth_year');
    heightSpan = document.querySelector('span#height');
    homeworldSpan = document.querySelector('span#homeworld');
    openingCrawl = document.querySelector('span#mass');
